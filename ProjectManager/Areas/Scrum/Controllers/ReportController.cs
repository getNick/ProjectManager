    ...
    public class ReportController : Controller
    {
        ...
        public IActionResult Index(int? selectedDepartmentId, int? selectedTeamId, int? selectedPartId)
        {
            ...
            vm.WorkPeriods = new List<Object>()
            {
                ...
                {
                    text = "Task1",
                    startDate = "2018-06-18T07:58:00.000Z",
                    endDate = "2018-06-18T08:48:00.000Z"
                },
                new
                {  text = "Task1",
                    startDate = "2018-06-18T09:40:00.000Z",
                    endDate = "2018-06-18T12:58:00.000Z"
                },
                new
                {
                    text = "Task1",
                    startDate = "2018-06-18T13:15:00.000Z",
                    endDate = "2018-06-18T15:58:00.000Z"
                },
            };
            //}
