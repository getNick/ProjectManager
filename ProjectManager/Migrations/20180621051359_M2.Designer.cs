...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManager.Models.Condition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int?>("ProductKnowledgeRuleId");
                    ...
                    b.HasIndex("ProductKnowledgeRuleId");
            ...
            modelBuilder.Entity("ProjectManager.Models.ProductKnowledgeRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ProjectManager.Models.ProductKnowledgeVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ProjectManager.Models.Condition", b =>
                {
                    b.HasOne("ProjectManager.Models.ProductKnowledgeRule")
                        .WithMany("Conditions")
                        .HasForeignKey("ProductKnowledgeRuleId");
                });
            ...
            modelBuilder.Entity("ProjectManager.Models.ProductKnowledgeRule", b =>
                {
                    b.HasOne("ProjectManager.Models.ProductKnowledgeVariable", "LeftVariable")
                        .WithMany()
                        .HasForeignKey("LeftVariableId");

                    b.HasOne("ProjectManager.Models.ProductKnowledgeVariable", "RightVariable")
                        .WithMany()
