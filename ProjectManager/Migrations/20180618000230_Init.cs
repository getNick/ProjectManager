        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_ProjectActivities_ActivitiesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_ProjectActivities_ActivitiesId",
                        column: x => x.ActivitiesId,
                        principalTable: "ProjectActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_ProjectActivities_ActivitiesId",
                        column: x => x.ActivitiesId,
                        principalTable: "ProjectActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_Participants_AutorId",
                        column: x => x.AutorId,
                        principalTable: "Participants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comment_Comments_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Description = table.Column<string>(nullable: true),
                    InitializerId = table.Column<int>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    ProjectActivitiesId = table.Column<int>(nullable: true),
                    Time = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectActivity_Participants_InitializerId",
                        column: x => x.InitializerId,
                        principalTable: "Participants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectActivity_ProjectActivities_ProjectActivitiesId",
                        column: x => x.ProjectActivitiesId,
                        principalTable: "ProjectActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tasks_ProjectActivities_ActivitiesId",
                        column: x => x.ActivitiesId,
                        principalTable: "ProjectActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Comments_CommentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkPeriod_Participants_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_ActivitiesId",
                table: "Departments",
                column: "ActivitiesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectActivity_InitializerId",
                table: "ProjectActivity",
                column: "InitializerId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectActivity_ProjectActivitiesId",
                table: "ProjectActivity",
                column: "ProjectActivitiesId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_ActivitiesId",
                table: "Projects",
                column: "ActivitiesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkPeriod_ParticipantId",
                table: "WorkPeriod",
